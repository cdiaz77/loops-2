...
# # 1. age 
# age = 16 #integar variable
# # 2. name
# name ="citlali" # strong variable
# # 3. song
# song= "happy birthday" #string variable 
# # 4. food
# food="pizza" #string variable
# # 5. number
# number = 50 #integar variable
...
# #a variable is a label that we can use to store data
...
print(phrase2[0])#prints the first letter of phrase2
print(phrase2[1])
print(phrase2[5])
print(phrase2[13])
#string slicing if i want it to get entire word
print (phrase2[13:18]) #prints the first word
print(phrase2[19:23])
print(phrase2[0:7])
